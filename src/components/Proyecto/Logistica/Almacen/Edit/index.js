...
class ProyectoLogisticaAlmacenEdit extends React.Component {
    constructor(props) {
      super(props);
      var idAlmacen=props.match.params.id;
   ...
   onChangeTipo(e) {
    ...
    render() {
      return(
        <div className='info'>
          ...
          <div>
            <h4>Almacen Editado con exito !</h4>
    ...
    newAlmacen() {
        AlmacenService.get(this.state.id)
        .then(response => {
            this.setState({
              id:response.data.id,
  ...
  export default ProyectoLogisticaAlmacenEdit