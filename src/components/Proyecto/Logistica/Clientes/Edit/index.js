...
class ProyectoLogisticaClientesEdit extends React.Component {
   
    constructor(props) {
      super(props);
      var idCliente=props.match.params.id
    ...
    render() {
      return(
        <div className='info'>
          ...
          <div>
            <h4>Cliente editado con exito !</h4>
    ...
    newCliente() {
        ClinteService.get(this.state.id)
        .then(response => {
          this.setState({
            id: response.data.id,
  ...
  export default ProyectoLogisticaClientesEdit