...
class ProyectoLogisticaProveedorEdit extends React.Component {
    constructor(props) {
      super(props);
      var idProveedor=props.match.params.id;
    ...
    render() {
      return(
        <div className='info'>
          ...
          <div>
            <h4>Proveedor editado con exito !</h4>
    ...
    newProveedor() {
        ProveedorService.get(this.state.id)
        .then(response => {
            this.setState({
  ...
  export default ProyectoLogisticaProveedorEdit;